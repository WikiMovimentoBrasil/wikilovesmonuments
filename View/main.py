...
if __name__ == '__main__':
        ...
        for file in get_all_files_cat('Category:Images_from_Wiki_Loves_Monuments_2021_in_Brazil'):
                ...
                wlm_edition = get_or_create(db.session, Edition, year="2021", country="Brazil", place_1=get_winners('Wiki_Loves_Monuments_2021_winners#Brazil')[0], place_2=get_winners('Wiki_Loves_Monuments_2021_winners#Brazil')[1], place_3=get_winners('Wiki_Loves_Monuments_2021_winners#Brazil')[2], place_4=get_winners('Wiki_Loves_Monuments_2021_winners#Brazil')[3], place_5=get_winners('Wiki_Loves_Monuments_2021_winners#Brazil')[4], place_6=get_winners('Wiki_Loves_Monuments_2021_winners#Brazil')[5], place_7=get_winners('Wiki_Loves_Monuments_2021_winners#Brazil')[6], place_8=get_winners('Wiki_Loves_Monuments_2021_winners#Brazil')[7], place_9=get_winners('Wiki_Loves_Monuments_2021_winners#Brazil')[8], place_10=get_winners('Wiki_Loves_Monuments_2021_winners#Brazil')[9])
